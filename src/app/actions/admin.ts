...
export async function saveSettings(formData: FormData) {
  ...
  const next: ShopSettings = {
    ...
    mtnAccountName: String(formData.get("mtnAccountName") ?? current.mtnAccountName),
    orangeMerchantCode: String(formData.get("orangeMerchantCode") ?? current.orangeMerchantCode),
    orangeMerchantName: String(formData.get("orangeMerchantName") ?? current.orangeMerchantName),
